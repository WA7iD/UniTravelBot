...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"Привет, {update.effective_user.first_name}! 🎯 Думал(а) о ВУЗе, в который будешь поступать, а с городом решил(а)?\n 
        "Давай, мы тебя быстренько соориентируем😉 Пройди для начала короткий тест, чтобы узнать, кем ты можешь быть во взрослом мире!" \n"
